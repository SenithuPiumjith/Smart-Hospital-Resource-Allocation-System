...
| `beds\_status.txt` | Bed occupancy grid - loaded on startup, saved after each admission |

| `patient\_records.txt` | Append only log of every billing transaction, across all runs |
